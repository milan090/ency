import { BlackBorderWhiteBGButton } from "src/client/components/CustomButtons/whitebg-button.component";
import React, { useCallback, useEffect, useState } from "react";
import Link from "next/link";
import { DollarSign, Globe, Home, IconProps, LogOut, Plus, Settings, User } from "react-feather";
import { useRouter } from "next/dist/client/router";
import { ModalContainer } from "src/client/components/modal-container/modal-container.components";
import { CreateProject } from "src/client/layouts/create-project-layout/create-project.layout";
import { StartWithEncy } from "src/client/layouts/create-project-layout/start-with-ency.layout";
